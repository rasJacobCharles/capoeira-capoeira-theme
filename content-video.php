...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php capoeiratheme_post_thumbnail(); ?>
	...
	<header class="entry-header">
		...
		<div class="entry-meta">
			...
			<?php edit_post_link( __( 'Edit', 'capoeiratheme' ), '<span class="edit-link">', '</span>' ); ?>
		</div><!-- .entry-meta -->
	</header><!-- .entry-header -->
	...
	<div class="entry-content">
		<?php
			...
			the_content( sprintf(
				__( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'capoeiratheme' ),
